...
namespace cheat::game::filters
{
	...
	namespace guide
	{
		SimpleFilter Chest = { app::EntityType__Enum_1::Chest, "_Box" };
		...
		SimpleFilter MonsterSkillObj = { app::EntityType__Enum_1::Gadget, "_Monster" };
		SimpleFilter MysteriousCarvings = { app::EntityType__Enum_1::Gadget, "_ReginStatue" };
		SimpleFilter MiracleRing = { app::EntityType__Enum_1::MiracleRing, "_Stages" };
		...
		SimpleFilter Qqtotem = { app::EntityType__Enum_1::Gadget, "_Gear" };
		SimpleFilter Qqfly = { app::EntityType__Enum_1::Platform, "_Gear" };
		...
		SimpleFilter test = { app::EntityType__Enum_1::Gadget, "_Area" };
	...
	namespace living
	{
		...
		SimpleFilter Avatar = { app::EntityType__Enum_1::Avatar, "_" }; //just for test
		...
		SimpleFilter Npc = { app::EntityType__Enum_1::NPC, std::vector<std::string> { "_Liyue", "_Mengde", "_Inazuma", "_Enkanomiya", "_Sumeru", "_Fontaine", "_Natlan", "_Snezhnaya", "_Coop", "_Quest",  "_Animal", "_Guide", "_Homeworld", "_Avatar", "_Kanban", "_Monster" }};		 //Genshin Impact 6.0 leak	
	...
	namespace monster
	{
		SimpleFilter SentryTurrets = { app::EntityType__Enum_1::Field, "_SentryTurrets" };
